...
## Вывод
В ходе работы были приобретены навыки подготовки сверточных слоев сверточных моделей, дообучения готовых сверточных моделей классификации а также метрик точности работы модели.